...
import cn.ucai.kind.widget.Sidebar;
...
public class PickContactNoCheckboxActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.kind.R.layout.activity_pick_contact_no_checkbox);
		listView = (ListView) findViewById(cn.ucai.kind.R.id.list);
		sidebar = (Sidebar) findViewById(cn.ucai.kind.R.id.sidebar);
		sidebar.setListView(listView);
		contactList = new ArrayList<User>();
		// 获取设置contactlist
		getContactList();
		// 设置adapter
		contactAdapter = new ContactAdapter(this, cn.ucai.kind.R.layout.row_contact, contactList);
