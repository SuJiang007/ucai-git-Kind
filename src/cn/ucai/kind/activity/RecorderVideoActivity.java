...
import cn.ucai.kind.video.util.Utils;
...
public class RecorderVideoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.kind.R.layout.recorder_activity);
	...
	private void initViews() {
		btn_switch = (Button) findViewById(cn.ucai.kind.R.id.switch_btn);
		btn_switch.setOnClickListener(this);
		btn_switch.setVisibility(View.VISIBLE);
		mVideoView = (VideoView) findViewById(cn.ucai.kind.R.id.mVideoView);
		btnStart = (ImageView) findViewById(cn.ucai.kind.R.id.recorder_start);
		btnStop = (ImageView) findViewById(cn.ucai.kind.R.id.recorder_stop);
		btnStart.setOnClickListener(this);
		btnStop.setOnClickListener(this);
		mSurfaceHolder = mVideoView.getHolder();
		mSurfaceHolder.addCallback(this);
		mSurfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
		chronometer = (Chronometer) findViewById(cn.ucai.kind.R.id.chronometer);
	}
...
//		}
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case cn.ucai.kind.R.id.switch_btn:
			switchCamera();
			break;
		case cn.ucai.kind.R.id.recorder_start:
			// start recording
		    if(!startRecording())
		        return;
			Toast.makeText(this, cn.ucai.kind.R.string.The_video_to_start, Toast.LENGTH_SHORT).show();
			...
			chronometer.start();
			break;
		case cn.ucai.kind.R.id.recorder_stop:
			...
			new AlertDialog.Builder(this)
					.setMessage(cn.ucai.kind.R.string.Whether_to_send)
					.setPositiveButton(cn.ucai.kind.R.string.ok,
					...
					.setNegativeButton(cn.ucai.kind.R.string.cancel,
							new DialogInterface.OnClickListener() {
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(cn.ucai.kind.R.string.Whether_to_send);
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(cn.ucai.kind.R.string.ok,
							new DialogInterface.OnClickListener() {
							...
							}).setNegativeButton(cn.ucai.kind.R.string.cancel, null)
					.setCancelable(false).show();
		}
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(cn.ucai.kind.R.string.prompt)
				.setMessage(cn.ucai.kind.R.string.Open_the_equipment_failure)
				.setPositiveButton(cn.ucai.kind.R.string.ok,
						new DialogInterface.OnClickListener() {
